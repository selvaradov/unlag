...
// plans over for more than a week are removed. A failed delivery is retried next run.
...
export default async (): Promise<Response> => {
  ...
  return new Response(JSON.stringify({ subscriptions: blobs.length, sent, removed, retried }), {

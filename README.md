...
on a noon to noon strip. Pinching follows the fingers and updates text, widths and spacing;
...
Zoom checks ([details](analysis/zoom-performance.md)): `node analysis/zoom-benchmark.mjs --touch --playwright <module-path>`.
